...
def attack(char_name: str, char_class: str) -> str:
    """Функция подсчетаа наносимого урона."""
    ...
    return (f'{char_name} не нанес урона сопернику')


def defence(char_name: str, char_class: str) -> str:
    """Функция заблокированного урона."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    ...
    return (f'{char_name} не смог пременить специальное умение')
